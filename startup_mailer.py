...
# Account Information
#to = 'sergio.rivera@colorado.edu' # Email to send to.
to = 'atlaslighttower@lists.colorado.edu' # Email to send to.
gmail_user = 'sergioatlastower@gmail.com' # Email to send from. (MUST BE GMAIL)
gmail_password = 'atlastest' # Gmail password.
